#ifndef UNBREAKABLEOBSTACLE_HPP_
#define UNBREAKABLEOBSTACLE_HPP_

#include "Obstacle.hpp"

class UnbreakableObstacle : public Obstacle {
  std::pair<float, float> tmp;

public:
  UnbreakableObstacle() : Obstacle(UNBREAKABLE) { sym = 'x'; }
  ...
  //  virtual obstacle_type getObstacleType() const {return UNBREAKABLE;}
...
#endif /* !UNBREAKABLEOBSTACLE_HPP_ */
